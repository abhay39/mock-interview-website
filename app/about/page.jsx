    ...
    <div>
      ...
      <main className="flex flex-col items-center justify-center min-h-screen py-6 bg-gray-50 px-2">
        <div className="w-full max-w-4xl px-6 py-6 bg-white rounded-lg shadow-md">
          <h1 className="text-2xl md:text-4xl font-bold text-center text-blue-600">About Us</h1>
          ...
          <div className="flex flex-col items-center mt-8 space-y-8">
            <div className="flex flex-col items-center">
              <Image src="/a.png" height={300} width={300} alt="Abhay Kumar Gupta" className=" w-[100px] md:w-[150px]  h-[100px] md:h-[150px] rounded-full" />
              <h2 className="mt-4 text-xl md:text-2xl font-semibold text-gray-800">Abhay Kumar Gupta</h2>
              <p className="mt-2 text-sm md:text-xl text-gray-600">Founder & CEO</p>
            </div>
          </div>

          <h2 className="mt-8 text-xl md:text-3xl font-bold text-center text-gray-800">Our Story</h2>
          <p className="mt-4 text-sm md:text-lg text-gray-700">
          ...
          <h2 className="mt-8 text-xl md:text-3xl font-bold text-center text-gray-800">Our Values</h2>
          <ul className="mt-4 space-y-2 text-sm md:text-lg text-gray-700">
